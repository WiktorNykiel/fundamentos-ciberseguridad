...
import {emptyState,validateState,parseImport,progress,moduleDone,escapeHTML} from '../assets/state.js';
...
test('limitar archivo importado',()=>{assert.throws(()=>parseImport(' '.repeat(200001),course));});
