...
def notes_and_quizzes():
    ...
    for mid, values in LESSONS.items():
        ...
        notes[mid] = f'## {mid} · {title}\n\n### Entender el mecanismo\n\n{model}\n\n### Llevarlo a una tarea\n\n{application}\n\n### Qué debes demostrar\n\n{evidence}\n\nConsulta los manuales de la versión instalada y las [fuentes del curso](https://github.com/WiktorNykiel/fundamentos-ciberseguridad/blob/main/formacion/sistemas-operativos/FUENTES.md).'
