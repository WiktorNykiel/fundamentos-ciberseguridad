...
This release completes the implementation prepared for PR #20 (`feat/campus-es-en-portable`), reusing its seven English source files rather than discarding the earlier work. It keeps the active course IDs, hours and v1 progress format. The separate master-plan documents in `main` must be retained when merging.
