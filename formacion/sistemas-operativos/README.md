...
**Wiktor Nykiel · Formación independiente en español · Campus 2.0.**

[**Campus web: lectura, presentación y progreso**](../../campus/README.md) · [Desplegar en Pages](../../campus/DEPLOY-CLOUDFLARE.md) · [Plan docente](PLAN-DOCENTE.md) · [Inicio práctico](INICIO-RAPIDO.md) · [Laboratorio](LABORATORIO.md)
...
Para el docente: [guía de impartición](GUIA-DOCENTE.md), [banco inicial de preguntas](BANCO-PREGUNTAS.md) y [capstone](CAPSTONE.md). Cualquier examen reservado o expediente debe custodiarse fuera de este repositorio público.
...
El repositorio renombrado es público. El despliegue en Pages requiere crear/conectar un proyecto y comprobar su URL; no se deriva de la visibilidad de GitHub. Ver [Publicación](PUBLICACION.md), [Validación](VALIDACION.md) y [Edición del campus](../../campus/EDICION.md).
